...
This repository ships the CLI plus first-party plugins. Docs live in `nopo/docs` and publish to https://more-nopo.github.io/nopo/. mcp lands in a later commit.
